...
* meta : {
    roles: ['MASTER','editor']     will control the page roles (you can set multiple roles)
...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [{
      path: 'load-plan-runs',
      component: () => import('@/views/operator/load-plan-runs/index'),
      name: 'loadPlans',
      meta: {
        title: 'loadPlanRuns'
      }
      ...
      path: 'sessions',
      component: () => import('@/views/operator/sessions/index'),
      name: 'sessions',
      meta: {
        title: 'sessions'
      }
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      component: () => import('@/views/executables/index'),
      name: 'executables',
      meta: { title: 'executables', icon: 'exe-black', noCache: true }
    }]
  },
  {
    path: '/security',
    ...
    children: [{
      ...
      name: 'security',
      meta: { title: 'security', icon: 'locked', noCache: true }
    }]
  },
  {
    path: '/connections',
    ...
    children: [{
      ...
      name: 'connections',
      meta: { title: 'connections', icon: 'plug', noCache: true }
    }]
  },
  {
    path: '/settings',
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      component: () => import('@/views/pulse/index'),
      name: 'pulse',
      meta: { title: 'pulse', icon: 'pulse', noCache: true }
    }]
  },
  {
    path: '/users',
    ...
    children: [{
      ...
      name: 'users',
      meta: { title: 'users', icon: 'users', noCache: true }
    }]
  },
  {
    path: '',
    ...
    beforeEnter(to, from, next) {
      window.open('https://github.com/bluecolor/alchemist', '_blank')
    },
    children: [{
      path: 'index',
      name: 'project',
      meta: { title: 'project', icon: 'github-logo', noCache: true }
    }]
  }
  // {
  //   path: '/documentation',
...
export const asyncRouterMap = [
  ...
  //     title: 'permission',
  //     icon: 'lock',
  //     roles: ['MASTER', 'editor'] // you can set roles in root nav
  //   },
  //   children: [{
  //     path: 'page',
